...
public class PlayerViewOld extends ViewSwitcher implements Observer {
	...
	private EditText mEditGor;
	private TextView mTextGor;
	private TextView mClub;
	private TextView mCountry;
	private TextView mGrade;
	private TextView mName;

	public PlayerViewOld(Context context) {
		this(context, null);
	}
	
	public PlayerViewOld(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void updateAssignments() {
		...
		mEditGor = (EditText) mSimple.findViewById(R.id.playerEditGor);
		mTextGor = (TextView) mComplex.findViewById(R.id.playerTextGor);
	...
	private void attachListeners() {
		mEditGor.addTextChangedListener(new TextWatcher() {
	...
	public void updateAttributes() {
		...
		if (getCurrentView() == mComplex) {
			...
			mTextGor.setText( Integer.toString(mPlayer.getGor()) );
		} else {
			mEditGor.setTextKeepState( Integer.toString(mPlayer.getGor()) );
		}
	}
